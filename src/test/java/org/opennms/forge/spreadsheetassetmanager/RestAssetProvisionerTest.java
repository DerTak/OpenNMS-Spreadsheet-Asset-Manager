...
/**
 * <p>RestAssetProvisionerTest class.</p>
 *
 ...
 * @since 1.0-SNAPSHOT
 */
public class RestAssetProvisionerTest {

    private static Logger logger = LoggerFactory.getLogger(RestAssetProvisionerTest.class);
...
//    private String m_password = "admin";
    ...
    private RestAssetProvisioner m_provider;
