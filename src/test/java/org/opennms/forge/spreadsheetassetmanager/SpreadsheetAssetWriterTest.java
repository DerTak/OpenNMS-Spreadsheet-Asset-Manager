 ...
 */
public class SpreadsheetAssetWriterTest {

    private static org.slf4j.Logger logger = LoggerFactory.getLogger(SpreadsheetAssetWriterTest.class);

    private SpreadsheetAssetWriter writer;

    @Before
    public void setup() {
        writer = new SpreadsheetAssetWriter();
    }
