...
/**
 * Provides static methods to read node and asset data from a remote OpenNMS.
...
public final class RestAssetReader {

    /**
     * Logging
     */
    private static Logger logger = LoggerFactory.getLogger(RestAssetReader.class);
 
    /** Suppress default constructor for noninstantiability */
    private RestAssetReader() {
    }
    ...
    public static File generateOdsFile(String foreignSource, RestConnectionParameter connectionParameter, File templateOds) {
        ...
        SpreadsheetAssetWriter spreadsheetWriter = new SpreadsheetAssetWriter();
